...
def assemble_pflotran_input(input_dir: str, save_dir: str, data_dir: str, fname: str, year: str, write_trans_flow: bool):
    ...
    if write_trans_flow:
        ...
        usfile = '/Users/christiandewey/Code/meander-models/pflotran-files/2D/build-scripts/transient-input/mzt-18-no-dam/mzt-NODAM_us_2018_4-1_10-31-MZT.txt'
        dsfile = '/Users/christiandewey/Code/meander-models/pflotran-files/2D/build-scripts/transient-input/mzt-18-no-dam/mzt-NODAM_ds_2018_4-1_10-31-MZT.txt'

        write_transient_flow_conditions(nx=108,upstream_file = usfile ,downstream_file=dsfile,save_dir=save_dir)
         
    region_block = write_regions(nx=108)

    flow_conditions_block = write_flow_conditions(nx=108, upstream_h=1.84, downstream_h=1.46, spin=False)
...
if __name__ == '__main__':
    ...
    input_dir = str(SCRIPT_DIR / 'mzt-18-no-dam') + '/'
    save_dir = str(SCRIPT_DIR / 'mzt-18-no-dam') + '/'
    data_dir = str(SCRIPT_DIR / 'bc_chem_data') + '/'

    fname = 'pflotran-sim-n.in'

    assemble_pflotran_input(input_dir, save_dir, data_dir, fname, '2018', write_trans_flow=True)
