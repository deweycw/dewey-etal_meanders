...
def assemble_pflotran_input(input_dir: str, save_dir: str, data_dir: str, fname: str, year: str, write_trans_flow: bool):
    ...
    if write_trans_flow:
        ...
        usfile = '/Users/christiandewey/Code/meander-models/pflotran-files/2D/bcs/hydro_us_2018_4-1_10-31-MZT.txt'
        dsfile = '/Users/christiandewey/Code/meander-models/pflotran-files/2D/bcs/hydro_ds_2018_4-1_10-31-MZT.txt'

        write_transient_flow_conditions(nx=108,upstream_file = usfile ,downstream_file=dsfile,input_dir=input_dir)
