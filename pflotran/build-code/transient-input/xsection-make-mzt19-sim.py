...
def assemble_pflotran_input(input_dir: str, save_dir: str, data_dir: str, fname: str, year: str, write_trans_flow: bool):
    ...
    if write_trans_flow:
        ...
        usfile = '/Users/christiandewey/Code/meander-models/pflotran-files/2D/bcs/hydro_us_2019_4-21_10-2-MZT.txt'
        dsfile = '/Users/christiandewey/Code/meander-models/pflotran-files/2D/bcs/hydro_ds_2019_4-21_10-2-MZT.txt'
    ...
    flow_conditions_block = write_flow_conditions(nx=108, upstream_h=1.94, downstream_h=1.66, spin=False)
...
if __name__ == '__main__':
    ...
    input_dir = str(SCRIPT_DIR / 'mzt-19') + '/'
    save_dir = str(SCRIPT_DIR / 'mzt-19') + '/'
